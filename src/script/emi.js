...
function CalculateClick(){
    ...
    document.getElementById("lblResult").innerHTML = "Your monthly installment amount is <span class='fw-bold fs-4'>" + Math.round(EMI).toLocaleString('en-in', {style:'currency', currency:'INR'}) + "<span> for next " + N  + " Months";
}